const Page5C = () => {
  ...
  return (
      <div className="contenedor">
          <img src="https://firebasestorage.googleapis.com/v0/b/tarjeta-invitacion-2f4f0.appspot.com/o/MALE%20Y%20NICO%20(BODA)-06.jpg?alt=media&token=7450df35-3e7f-4be1-9196-782ad216a55f" alt="" style={{ maxWidth: '100%', maxHeight: '100%' }} />
