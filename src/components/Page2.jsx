...
const Page2 = () => {
  ...
  <img src="https://firebasestorage.googleapis.com/v0/b/tarjeta-invitacion-2f4f0.appspot.com/o/MALE%20Y%20NICO%20(BODA)-02.jpg?alt=media&token=3cc05f42-07be-4a8d-8232-b75150d43ee9"
    alt=""
    style={{ maxWidth: '100%', maxHeight: '100%' }}
  />
  <div className="contador" style={{ position: 'absolute', top: '63%', left: '50%', transform: 'translate(-50%, -50%)' ,display: 'flex', flexDirection: 'row'}}>
